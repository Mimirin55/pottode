...
## サービスの差別化ポイント・推しポイント
完成形としては、以下の競合アプリ3つのメリットを合わせたようなものをイメージしています。
### 【競合1】スマホアプリのメモ帳
#### 同じ機能
- アカウント登録しなくても使用できます。
- ブラウザ・スマホ両方で素早く動作できるようにします。
...
- グループでリアルタイムに編集できます。
#### 追加したい機能
- 自分の許可したアカウントのみ共有可能できます（グループ招待制）。
### 【競合3】esa
#### 同じ機能
- Miroと同じく、グループでリアルタイムに編集できます。
#### 追加したい機能
- 自分だけが見たい情報は、他のアカウントにアクセスさせないようにします。
